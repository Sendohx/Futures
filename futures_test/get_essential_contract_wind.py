...
if __name__ == '__main__':
    get1 = get_essential_contract('CU', 'com', '20230103', '20230110')
    print(get1.run())

    get2 = get_essential_contract('CU', 'com', '20230103', '20230110')
    print(get2.run())

    get3= get_essential_contract('CU', 'com', '20230103', '20230110')
    print(get3.run())
